...
export declare class TicketTypesService {
    ...
    findOne(id: string): import("mongoose").Query<import("mongoose").Document<unknown, any, TicketTypeDocument> & import("src/lib/entities/ticketType.entity").ITicketType & Document & {
        _id: import("mongoose").Types.ObjectId;
    }, import("mongoose").Document<unknown, any, TicketTypeDocument> & import("src/lib/entities/ticketType.entity").ITicketType & Document & {
        _id: import("mongoose").Types.ObjectId;
    }, {}, TicketTypeDocument>;
