...
let AuthService = class AuthService {
    ...
    async createAccount(payload) {
        ...
        else if (payload.role === types_1.Roles.EVENTAGENT) {
            return await this.usersService.create(Object.assign(Object.assign({}, payload.data), { role: types_1.Roles.EVENTAGENT }));
        }
    }
