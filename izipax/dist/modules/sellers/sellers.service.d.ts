...
export declare class SellersService {
    ...
    find(query: FilterQuery<SellerDocument>): Promise<(import("mongoose").Document<unknown, any, SellerDocument> & import("src/lib/entities/seller.entity").ISeller & Document & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
