...
let TransactionsService = class TransactionsService {
    ...
    async create(payload) {
        ...
        if (payload.paymentMethod === types_1.TransactionMETHODS.MTNBJ &&
            payload.type === types_1.TransactionTYPES.PAYMENT) {
            const transaction = await this.transactionModel.create(Object.assign(Object.assign({}, payload), { transref: new Date().getTime().toString() }));
            if (!transaction)
