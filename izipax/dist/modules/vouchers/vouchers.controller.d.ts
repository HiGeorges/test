...
export declare class VouchersController {
    ...
    update(id: ParseIdPipe, updateVoucherDto: VoucherUpdateDto): Promise<import("mongoose").Document<unknown, any, import("../../lib/entities").VoucherDocument> & import("../../lib/entities").IVoucher & Document & {
        _id: import("mongoose").Types.ObjectId;
    }>;
