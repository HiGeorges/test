...
export declare class VouchersService {
    ...
    find(query: FilterQuery<VoucherDocument>): Promise<(import("mongoose").Document<unknown, any, VoucherDocument> & import("src/lib/entities/voucher.entity").IVoucher & Document & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
    ...
    update(id: ParseIdPipe, updateVoucherDto: VoucherUpdateDto): Promise<import("mongoose").Document<unknown, any, VoucherDocument> & import("src/lib/entities/voucher.entity").IVoucher & Document & {
        _id: import("mongoose").Types.ObjectId;
    }>;
